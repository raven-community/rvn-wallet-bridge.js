...
class RVNWalletBridge {
    constructor(walletProvider) {
        ...
        this.isP2SHRvn2Address = (address) => {
            try {
                if (!this.isRvn2Address(address) || !rvnaddrjs_1.isP2SHAddress(address)) {
                    return false;
                }
            }
            catch (e) {
        ...
        this.isRvn2Address = (address) => {
            try {
                if (!rvnaddrjs_1.isRvn2Address(address)) {
                    return false;
                }
            }
            catch (e) {
        ...
        this.toAddressFromScript = (script) => {
            ...
            return rvnaddrjs_1.toRvn2Address(legacy);
        };
    }
    ...
    async getRedeemScript(p2shAddress, dAppId) {
        if (!this.isP2SHRvn2Address(p2shAddress)) {
            throw new IllegalArgumentException_1.default("The address is not P2SH Address or Rvn2 Address.");
        }
    ...
    async sign(address, dataToSign) {
        if (!this.isRvn2Address(address)) {
            throw new IllegalArgumentException_1.default("The address is not Rvn2 Address format.");
        }
